...
func (s ParcelStore) Get(number int) (Parcel, error) {
	...
	p = Parcel{number, a, status, address, created_at}
...
func (s ParcelStore) GetByClient(client int) ([]Parcel, error) {
	...
	for rows.Next() {
		...
		p := Parcel{number, client, status, address, created_at}
		res = append(res, p)
	}
	return res, nil
}
